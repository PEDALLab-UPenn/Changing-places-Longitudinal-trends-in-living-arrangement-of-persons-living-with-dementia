...
* Rename variables 
rename(re`i'dcensdiv w`i'varunit w`i'anfinwgt0 w`i'varstrat r`i'd2intvrage r5dgender rl5dracehisp)(redcensdiv wvarunit wanfinwgt0 wvarstrat age_cat gender racehisp)
...
**************************************************
*** Section 3 Generate Demographic Variables ***
**************************************************
** Marital Status 
...
** Code for each ADL activity
	...
	* SC: dressing 
	g needhelp_dress=.
		...
		** If SC27: ever go without getting dressed because no one was there to help
...
********************************************************
use "$createddata/NHATS_Round5.dta", clear 
forv i=6/11 {
...
sa "$createddata/NHATS_Round5to11.dta", replace
