...
** Between 2015 and 2021, the proportion of respondents classified as probable dementia ranged from 9.6% to 11.8%.
...
use "$createddata/NHATS_Round5to11.dta", clear
keep if round==`i'

    ** Set svyset
    svyset wvarunit [pweight=wanfinwgt0], strata(wvarstrat) 
	
    ** Distribution of demclas
	    svy: proportion demclas
		matrix C=e(b)
		matselrc C B, r(1) c(1,2,3)
		mat colnames B= ProbDem PossDem NoDem
		matrix A = B'
